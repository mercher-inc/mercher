...
$this->pageTitle = Yii::app()->name . ' - ' . Yii::t('label', 'terms');
?>
...
<p>
    ...
    <strong>
        As Mercher is a platform integrated into Facebook&reg;, all store contact must follow
        Facebook&reg; Advertising Guidelines
        (<a href="https://www.facebook.com/help/399392800124391/">https://www.facebook.com/help/399392800124391/</a>)
        and may not sell any goods or  services not allowed on Facebook&reg;.
    </strong>
</p>
...
<p>
    Mercher is a platform that allows users to offer, sell and buy products. As a platform, Mercher does not own or
    sell the items or services listed on this website, so the actual contract for sale is directly between the
    sellers and buyers.
</p>
...
<p>
    ...
    through various programs, Mercher has no control over and does not guarantee the existence, quality, safety or
...
<ul>
    ...
    <li>
        You enter into a legally binding contract with the seller to purchase an item when you commit to buy an
        item.
    </li>
    <li>
        Pay attention to the details of the transaction, because your total price may include taxes, fees, and
        shipping costs, all of which you are responsible for funding.
    </li>
    <li>
        For motor vehicles and real estate, an offer initiates a non-binding transaction representing a buyer's
        serious expression of interest in buying the seller's item and does not create a formal contract between the
...
<ul>
    ...
    <li>
        To run a great business, sellers work hard to ensure smooth and professional transactions with their buyers.
        This includes setting buyer expectations and meeting those expectations. Some of the most basic things you
        can do as a seller are to provide accurate and consistent details about your item and to be clear and
        specific about the terms and conditions of the sale, including any applicable taxes. You should also make
    ...
    <li>
        Frequently reviewing and updating listings to make sure all information &ndash; such as inventory status and
        item
        condition &ndash; is accurate and up to date
    </li>
</ul>
...
<ul>
    <li>
        You understand that your Content is public. It can and will be seen by any user on public social networks
        and any external links to your item.
    </li>
    <li>
    ...
    <li>
        You retain all rights to any Content you submit for upload and use in Mercher. You agree that you own or
        have use rights to use all Content you reference or post in Mercher. In addition, you agree to the
        following: When you post Content, you are committing that the Content really, truly belongs only to you and
        that the posting and use of your Content does not violate the privacy rights, publicity rights, copyrights,
        contract rights, intellectual property rights, or human rights of any other person or entity. We are not
        responsible if the Content is not really yours or if you infringe on others' rights; you will be responsible
        if there are any costs associated with ownership and rights issues.
    </li>
    <li>
        If you terminate your application subscription, your Content from the website will not be used outside of
        the website anymore, but we might still have it stored in backup files or on servers for any legal reason.
    </li>
    <li>
        If you stop using the Mercher application your Content will remain in our website, unless you actively
        remove your Content.
    </li>
    <li>
...
<p>
    If you accept returns, a buyer can return an item for any reason, including when they change their mind about a
    purchase &ndash; as long as the return meets the return requirements &ndash; for example, returning an item within
    your stated time
    frame, and meeting item condition requirements.
</p>
...
<ul>
    <li>
        Specify if items or services can be returned. If you accept returns, you must specify:
    </li>
    <li>
...
<p>
    ...
    is
    the primary mechanism for sale consummation on Mercher. Mercher team will make inquiries and may conduct an
    ...
    taking typical internet commerce precautionary measures, including dealing locally and reviewing seller history.
</p>
...
<p>
    If any provision of this Agreement is held to be invalid, void or for any reason unenforceable, such provision shall
    be struck out and shall not affect the validity and enforceability of the remaining provisions.
</p>
...
<p>
    ...
    reasonable attorneys’ fees), whether under contract, warranty, tort (including negligence, strict liability, product
    liability or other theory) relating to any claim User Parties may now or later have due to or arising out of your
    access to and use of the content, the website, and services, any violation of this agreement or any violation of any
    rights of another. We reserve, and you grant to us, the right to assume exclusive defense and control of any matter
...
<p>
    Please contact us with any questions at <a href="mailto:support@mercher.net">support@mercher.net</a>
</p>
</div>