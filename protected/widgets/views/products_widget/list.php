    ...
    <div class="gridView">
        <div class="header hidden-sm hidden-xs">
            <div class="row">
                ...
                <div class="col-lg-1 col-md-1"><?php echo Yii::t(
                        'product',
                        Product::model()->getAttributeLabel('image_id')
                    ) ?></div>
                <div class="col-lg-2 col-md-2"><?php echo Yii::t(
                        'product',
                        Product::model()->getAttributeLabel('title')
                    ) ?></div>
                <div class="col-lg-1 col-md-1"><?php echo Yii::t(
                        'product',
                        Product::model()->getAttributeLabel('category')
                    ) ?></div>
                <div class="col-lg-1 col-md-1"><?php echo Yii::t(
                        'product',
                        Product::model()->getAttributeLabel('price')
                    ) ?></div>
                <div class="col-lg-3 col-md-3"><?php echo Yii::t(
                        'product',
                        Product::model()->getAttributeLabel('description')
                    ) ?></div>
                <div class="col-lg-1 col-md-1"><?php echo Yii::t(
                        'product',
                        Product::model()->getAttributeLabel('is_active')
                    ) ?></div>
                <div class="col-lg-1 col-md-1"><?php echo Yii::t(
                        'product',
                        Product::model()->getAttributeLabel('is_banned')
                    ) ?></div>
